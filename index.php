...
<html lang="en">
  ...
  ?>
            ...
            <div class="row intro py-1" style="background-color: black" >
              ...
              <div class="col-sm-12 col-md">
                <div class="heading text-center my-5">
                  <h3><font color ="silver" >Welcome to</font></h3>
                  <h1><font color ="White" >THE SPARKS BANK</font></h1>
                </div>
              </div>
      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  <div class="col-md act">
                    <img src="img/user.jpg" class="img-fluid" width ="200" height ="400">
                    <br>
                    <a href="createuser.php"><button style="background-color : #2785C4;">Create a User</button></a>
                  </div>
                  <div class="col-md act">
                    <img src="img/trans.jpg" class="img-fluid" width ="200" height ="400">
                    <br>
                    <a href="transfermoney.php"><button style="background-color : #2785C4;">Make a Transaction</button></a>
                  </div>
                  <div class="col-md act">
                    <img src="img/history.jpg" class="img-fluid" width ="200" height ="400">
                    <br>
      ...
      <footer class="text-center mt-5 py-2">
        <p>&copy 2021. Made by <b>Himani Waiker</b> <br> The Sparks Foundation </p>
      </footer>
